 ...
 * 取值约束（卡片 300 / gap 18）：5 列内容宽 5×300+4×18=1572，6 列临界 6×300+5×18=1890；
 * 故 1680 ≥1572（全屏放得下 5 列）且 <1890（封顶 5 列），1920 全屏 5 列居中左右各留约 54px。
 */
 ...
 * 这类页面是表单/文档，不应跟随书签网格宽度（1572）撑满——960 给左侧标签栏 200 + 右侧
